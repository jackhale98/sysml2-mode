...
(declare-function sysml2-fmi-batch-generate-modelica "sysml2-fmi")
...
(with-eval-after-load 'evil
  ...
  (with-eval-after-load 'general
    (general-define-key
     ...
     "s F" '(sysml2-fmi-batch-generate-modelica :which-key "batch Modelica (multi-file)")
     ...
     ;; SysML Simulation (sysml simulate)
     ...
     "= =" '(sysml2-format-buffer :which-key "format buffer")
     "= r" '(sysml2-format-region :which-key "format region")
     "= d" '(sysml2-format-diff :which-key "format diff")
     ;; CLI Analysis (sysml lint/check/list/show/trace/stats/deps/coverage)
     "t"   '(:ignore t :which-key "cli analysis")
     "t l" '(sysml2-cli-lint :which-key "lint")
     "t c" '(sysml2-cli-check :which-key "check")
     "t s" '(sysml2-cli-list :which-key "list elements")
     "t w" '(sysml2-cli-show :which-key "show element")
     "t t" '(sysml2-cli-trace :which-key "trace requirements")
