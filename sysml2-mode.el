...
(declare-function sysml2-format-diff "sysml2-format")
(declare-function sysml2-format-on-save-mode "sysml2-format")
(declare-function sysml2-cli-lint "sysml2-cli-commands")
(declare-function sysml2-cli-check "sysml2-cli-commands")
(declare-function sysml2-cli-list "sysml2-cli-commands")
(declare-function sysml2-cli-show "sysml2-cli-commands")
(declare-function sysml2-cli-trace "sysml2-cli-commands")
...
(defvar sysml2-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "C-c C-s B") #'sysml2-fmi-compile-all-fmus)
    (define-key map (kbd "C-c C-s d") #'sysml2-fmi-dashboard)
    ...
    (define-key map (kbd "C-c C-s P") #'sysml2-cosim-pipeline)
    ;; Simulation (sysml simulate)
    ...
    (define-key map (kbd "C-c C-= d") #'sysml2-format-diff)
    ;; CLI Analysis (sysml lint/check/list/show/trace/stats/deps/coverage)
    (define-key map (kbd "C-c C-t l") #'sysml2-cli-lint)
    (define-key map (kbd "C-c C-t c") #'sysml2-cli-check)
    (define-key map (kbd "C-c C-t s") #'sysml2-cli-list)
    (define-key map (kbd "C-c C-t w") #'sysml2-cli-show)
    (define-key map (kbd "C-c C-t t") #'sysml2-cli-trace)
    (define-key map (kbd "C-c C-t a") #'sysml2-cli-stats)
    (define-key map (kbd "C-c C-t d") #'sysml2-cli-deps)
    (define-key map (kbd "C-c C-t v") #'sysml2-cli-coverage)
    ;; Inspect / Report
